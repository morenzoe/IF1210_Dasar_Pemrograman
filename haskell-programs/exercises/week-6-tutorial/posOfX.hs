...
{- posOfX e lc menghasilkan sebuah bilangan
   integer yang menyatakan posisi e pada list
   of character lc. Jika e bukan elemen dari
   lc, fungsi akan menghasilkan 0.
   Prekondisi: lc memiliki elemen unik. -}

-- REALISASI FUNGSI
posOfX e lc
 | (isEmpty lc) = 0 -- basis kosong
 | ((head lc)==e) = 1 -- basis elemen ada di awal
 | otherwise = 1 + (posOfX e (tail lc)) -- rekurens
